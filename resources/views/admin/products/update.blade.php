...
<form action="{{route('admin.products.update',$product->id)}}" method="POST">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="title" value="{{$product->title}}" required="required" class="form-control @error('title') is-invalid @enderror" id="title">
    @error('title')
  ...
  <div class="mb-3">
    ...
    <input type="text" name="category_id" value="{{$product->category_id}}" class="form-control @error('category_id') is-invalid @enderror" id="category">
    @error('category_id')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" name="sale_off" value="{{$product->sale_off}}" class="form-control @error('sale_off') is-invalid @enderror" id="sale_off">
    @error('sale_off')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
  </div>
